...
TREE_PATH = os.environ['UR_PATH'] + '/ur_description/urdf/ur5_robot.urdf'

# Be sure to specify the correct experiment directory to save policy data at.
BASE_DIR = '/'.join(str.split(gps_filepath, '/')[:-2])
EXP_DIR = BASE_DIR + '/../experiments/ur_tensorflow_example/'
...
CONDITIONS   = 2 # Typically 2 for Tensorflow and 1 for LQR.
